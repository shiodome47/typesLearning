...
export const cpLesson05: Lesson = {
  ...
  why: {
    ...
    insight:
      ...
      "たいていは後者です。\n\n" +
      "**★ただし、ここで証明されたのは「18歳以上である」ことではありません。**\n" +
      "**「提出者は、この不等式を満たす数字を提出した」ということです。**\n\n" +
      "`localBirthYear()` は witness なので、実装は利用者の手元にあります。\n" +
      "17歳の人が `1990` を返す実装にすれば、この証明は通ります。\n" +
      "同じことが `currentYear` にも言えます。circuit の引数なので、" +
      "呼び出し側が `3000` を渡せば、生年が何であっても通ります。\n\n" +
      "**本当に年齢を保証したいなら、生年月日を知っている第三者" +
      "（自治体・発行機関 = issuer）に署名させ、その署名を回路の中で検証する必要があります。**\n\n" +
      "**この回で学ぶのは「値を隠したまま判定を書く方法」であって、" +
      "「真正性を保証する方法」ではありません。**この2つは別の問題です。\n\n" +
      "（その「署名を回路の中で検証する」にも、さらに落とし穴があります。⑥の最後で扱います）",
  },
  explanation:
